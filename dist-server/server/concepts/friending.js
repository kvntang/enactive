...
class FriendingConcept {
    ...
    constructor(collectionName) {
        this.friends = new doc_1.default(collectionName);
        this.requests = new doc_1.default(collectionName + "_requests");
    }
    getRequests(user) {
    ...
    acceptRequest(from, to) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([this.requests.createOne({ from, to, status: "accepted" }), this.addFriend(from, to)]);
    ...
    canSendRequest(u1, u2) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.assertNotFriends(u1, u2);
...
exports.default = FriendingConcept;
...
//# sourceMappingURL=friending.js.map