        ...
        messages: [
          {
            ...
            content: `Think about the most important subject matter in "${prompt}". Generate a list of 36 individual words closely related to this subject matter. The words should a noun, a subject matter. Be creative and poetic. Order the words from most similar to least similar in relation to the caption. Provide the list as words separated solely by commas, with no additional text, labels, or numbering.`
          },
        ],
      }),
    });
